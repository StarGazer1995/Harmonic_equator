...
// For a piezo buzzer
  ...
  #define STATUS_BUZZER_PIN     AUX8_PIN               // [must be low at boot 12] Tone
#endif
...
#define AXIS1_M3_PIN            4              // UART RX
#define AXIS1_STEP_PIN          18
#define AXIS1_DIR_PIN           19                // [must be high at boot 0]
...
#define ST4_DEC_N_PIN           35               // ST4 DE+ North
#define ST4_RA_E_PIN            33              // [input only 35] ST4 RA+ East
